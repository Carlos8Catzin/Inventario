...
$datos1 = $obj1 ->MostrarTodosChecker();
    $tabla1 = '
        ...
        <div style="padding:5px;">
            <button class="btn btn-app" type="submit" id="export_data" name="export_data">
    ...
    foreach($datos1 as $key1 => $value1){
        ...
        $datosTabla1 = $datosTabla1.'
                    ...
                    <tr>
                        <td><button class="btn btn-block" onclick="delCheckerAll('.$value1['IdPendiente'].');"><i class="fas fa-trash"></i></td>
